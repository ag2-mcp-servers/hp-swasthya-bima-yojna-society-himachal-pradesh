...
from models import (
    RsbycCertificatePostRequest,
    RsbycCertificatePostResponse,
    RsbycCertificatePostResponse1,
    RsbycCertificatePostResponse2,
    RsbycCertificatePostResponse3,
    RsbycCertificatePostResponse4,
    RsbycCertificatePostResponse5,
    RsbycCertificatePostResponse6,
)
...
app = MCPProxy(
    ...
    version='3.0.0',
    servers=[{'url': 'https://apisetu.gov.in/hpsbys/v3'}],
)
...
@app.post(
    ...
    tags=['health_card_management'],
    security=[
        APIKeyHeader(name="X-APISETU-APIKEY"),
        APIKeyHeader(name="X-APISETU-CLIENTID"),
    ],
)
def rsbyc(body: RsbycCertificatePostRequest = None):
    """
